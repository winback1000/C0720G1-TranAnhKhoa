...
public class TennisGameTest implements _08_refactoring_n_clean_code.exercise.src.Collection {
    ...
    public void checkAllScores() {
        ...
        assertEquals(this.expectedScore, _08_refactoring_n_clean_code.exercise.src.TennisGame.getScore(player1MaxScore, player2MaxScore));
    }
}